...
#ifndef __vtkPlaneExtend_h
#define __vtkPlaneExtend_h
...
class vtkPlaneExtend : public vtkPolyDataSourceWidget
{
public:
  // Description:
  // Instantiate the object.
  static vtkPlaneExtend *New();

  vtkTypeMacro(vtkPlaneExtend, vtkPolyDataSourceWidget);
...
//ETX
  ...
  int getThetaSign(double*, double*, double*, double*);
};
